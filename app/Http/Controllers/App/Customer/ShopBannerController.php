...
class ShopBannerController extends ResourceController{
	use FluentResponse;
	...
	public function index(){
		...
		try {
			...
			$all->transform(function (ShopBanner $ShopBanner){
				$payload = $ShopBanner->toArray();

				$payload['banner'] = Storage::disk('secured')->url($ShopBanner->getShopBanner()); 
				return $payload;
			});
