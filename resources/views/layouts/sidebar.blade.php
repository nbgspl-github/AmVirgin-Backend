	...
	<div class="sidebar-inner slimscrollleft">
		...
		<div id="sidebar-menu">
			<ul>
				...
				<li>
					<a href="{{route("categories.all")}}" class="waves-effect"><i class="mdi mdi-step-forward mt-1"></i> <span> Series </span></a>
				</li>

				<li>
					<a href="{{route("categories.all")}}" class="waves-effect"><i class="mdi mdi-television mt-1"></i> <span> Live TV </span></a>
				</li>

				<li>
					<a href="{{route("categories.all")}}" class="waves-effect"><i class="mdi mdi-server mt-1"></i> <span> Servers </span></a>
				</li>
				...
				<li>
					<a href="{{route("categories.all")}}" class="waves-effect"><i class="mdi mdi-settings mt-1"></i> <span> Settings </span></a>
				</li>
			</ul>
		</div>
