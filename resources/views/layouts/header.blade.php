        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{{asset("images/logo-amvg.png")}}" alt="homepage" class="dark-logo" height="50"/>
                    <!-- Light Logo icon -->
                    <img src="{{asset("images/logo-amvg.png")}}" alt="homepage" class="light-logo" height="50"/>
                </b>
                <!--End Logo icon -->
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href=""
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                src="{{asset("images/users/1.jpg")}}" alt="user" class=""> <span class="hidden-md-down">Mark &nbsp;<i
