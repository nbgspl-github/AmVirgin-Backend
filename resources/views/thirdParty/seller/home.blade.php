...
<nav class="navbar navbar-expand-lg navclass specific videohead" id="navbar">
	...
	<a class="navbar-brand" href="index.html">
		<img class="logoheader" src="img/logo.png" alt="amvirgin" id="logo"/>
	</a>
	<button class="mobbtn">

		<span class="mobicon" onclick="openNav()"><img class="mobmenuicon" src="img/mobmenu.png" alt="menu"/> </span>
	</button>
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="nav-item">
				<a class="nav-link" href="#"><img class="cart upp2" src="img/cart.png"/></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="#"><img class="userimage upp2" src="img/user.png"/>Sign in</a>
			</li>
	...
	<div class="bodysection">
		<aside class="side-nav sellernav" id="show-side-navigation1">
			...
			<ul class="categories">
				...
				<li><i class="fa fa-sign-out fa-fw"></i><a href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit()">Logout</a>
				</li>
				<form id="logout-form" action="{{ route('seller.logout') }}" method="POST" style="display: none;">{{ csrf_field() }}</form>
...
<script src="{{asset('dash/style.js')}}"></script>
</body>
