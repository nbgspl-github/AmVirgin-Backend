							...
							<form action="{{route('admin.announcements.index')}}">
								<div class="form-row float-right">
									...
									<div class="col my-auto">
										<a href="{{route('admin.announcements.create')}}" class="btn btn-outline-primary">Add</a>
									</div>
								</div>
							</form>
						</div>
							...
							<tr>
								...
								<td>
									@if($announcement->banner!=null)
										<img src="{{$announcement->banner}}" alt="" class="img-fluid img-thumbnail" style="max-width: 100px;">
									@else
								...
								<td>
									<div class="btn-toolbar" role="toolbar">
										<div class="btn-group" role="group">
											<a class="btn btn-outline-danger" href="{{route('admin.announcements.edit',$announcement->id)}}" @include('admin.extras.tooltip.bottom', ['title' => 'Edit'])><i class="mdi mdi-pencil"></i></a>
											<a class="btn btn-outline-primary" href="javascript:_delete('{{$announcement->id}}');" @include('admin.extras.tooltip.bottom', ['title' => 'Delete'])><i class="mdi mdi-minus-circle-outline"></i></a>
										</div>
									</div>
								</td>
							</tr>
