		...
		<div class="col-12">
			<div class="card shadow-sm">
				<div class="card-header py-0">
					<div class="row">
						<div class="col-8">
							<h5 class="page-title animatable">Create an announcement</h5>
						</div>
					</div>
				</div>
						...
						<div class="col-md-6 mx-auto">
							<form action="{{route('admin.announcements.store')}}" method="POST"
								...
								<div class="form-group">
									...
									<input type="file" name="banner" id="banner" data-show-remove="false" data-allowed-file-extensions="png jpg jpeg" data-max-file-size="2M">
								</div>
								<div class="form-group">
