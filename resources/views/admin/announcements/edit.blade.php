							...
							<form action="{{route('admin.announcements.update',$announcement->id)}}" method="POST"
								...
								<div class="form-group">
									...
									<input type="file" name="banner" id="banner" data-show-remove="false"
										   ...
										   data-default-file="{{$announcement->banner}}">
								</div>
								<div class="form-group">
									<label for="title">Title</label>
									<input id="title" type="text" name="title" class="form-control" required
										   placeholder="Title" minlength="2" maxlength="255"
								...
								<div class="form-group">
									...
									<input id="valid_from" type="datetime-local" name="validFrom" class="form-control"
										   ...
										   value="{{date("Y-m-d\TH:i:s",strtotime(old('validFrom',$announcement->validFrom)))}}"/>
								</div>
								<div class="form-group">
									<label for="valid_until">Valid Until</label>
									<input id="valid_until" type="datetime-local" name="validUntil" class="form-control"
										   required placeholder="Valid Until"
										   value="{{date("Y-m-d\TH:i:s",strtotime(old('validFrom',$announcement->validUntil)))}}"/>
								</div>
