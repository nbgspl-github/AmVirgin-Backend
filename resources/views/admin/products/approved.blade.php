        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header py-0">
                    <div class="row">
                        <div class="col-8">
                            <h5 class="page-title animatable table-responsive">Products (Approved)</h5>
                        </div>
								...
								<td>
									<div class="btn-toolbar" role="toolbar">
										<div class="btn-group" role="group">
											<a class="btn btn-outline-danger" href="{{route('admin.products.approved.details',$product->id)}}" @include('admin.extras.tooltip.bottom', ['title' => 'View product details'])><i class="mdi mdi-lightbulb-outline"></i></a>
										</div>
									</div>
								</td>
							</tr>
