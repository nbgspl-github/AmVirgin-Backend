		...
		<div class="col-12">
			<div class="card shadow-sm">
				<div class="card-header py-0">
					@include('admin.extras.header', ['title'=>'Edit video media'])
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-12">
							<form id="mediaForm" data-parsley-validate="true" method="POST" enctype="multipart/form-data">
								...
								<div class="form-row">
									...
									<div class="col-6">
										<a href="{{route("admin.videos.edit.action",$video->id)}}" class="btn btn-secondary waves-effect btn-block shadow-sm">
											Cancel
										</a>
									</div>
								</div>
	...
	<script>
		...
		function submitSource(event) {
			...
			showProgressDialog(true, () => {
				axios.post(`/admin/videos/${video_id}/update/media`, formData, config,).then(response => {
