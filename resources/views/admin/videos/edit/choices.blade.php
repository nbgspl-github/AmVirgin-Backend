		...
		<div class="col-12">
			<div class="card shadow-sm custom-card">
				...
				<div class="card-body animatable">
					<div class="jumbotron bg-white" style="background-image: url({{\Illuminate\Support\Facades\Storage::disk('secured')->url($payload->getBackdrop())}});">
						<div style="background-color: rgba(0,0,0,0.75); border-radius: 8px; backdrop-filter: blur(4px)" class="row shadow w-100">
							...
							<div class="col-sm-6 mr-0">
								<div class="card shadow-none border">
									<div class="card-body">
										...
										<p class="card-text">Choose this to manage sources for this video.</p>
