        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header py-0">
                    @include('admin.extras.header', ['title'=>'Edit link slider'])
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-sm-10 col-md-10 col-lg-8 col-xl-6 mx-auto">
                            <form action="{{route('admin.sliders.link.update',$slide->getKey())}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="targetLink" id="targetLink" class="form-control"
                                           ...
                                           @if($slide->type==\App\Models\Slider::TargetType['VideoKey']) disabled @endif/>
                                </div>
                                <div class="form-group">
