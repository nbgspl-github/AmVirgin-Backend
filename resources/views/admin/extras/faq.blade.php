		...
		<div class="col-12">
			<div class="card shadow-sm">
				<div class="card-header py-0">
					@include('admin.extras.header', ['title'=>'Frequently Asked Questions'])
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-12">
							<form action="{{route('admin.extras.faq.update')}}" data-parsley-validate="true"
								  method="POST" enctype="multipart/form-data">
								@csrf
								<div class="form-group">
									<textarea name="faq" id="faq" cols="30"
											  rows="10">{{old('faq',$faq)}}</textarea>
								</div>
								<div class="form-row">
									<div class="col-6">
										<button type="submit"
