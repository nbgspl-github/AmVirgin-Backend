        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <form action="{{route('admin.extras.terms-and-conditions.update')}}"
                                  data-parsley-validate="true" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <textarea name="terms_conditions" id="terms_conditions" cols="30"
                                              rows="10">{{old('terms_conditions',$terms_conditions)}}</textarea>
                                </div>
                                <div class="form-row">
                                    <div class="col-6">
                                        <button type="submit"
