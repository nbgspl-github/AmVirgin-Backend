					...
					<div class="form-row">
						<div class="col-12">
							<div class="form-group">
								...
								<input name="duration[]" pattern="^(?:(?:([01]?\\d|2[0-3]):){1}([0-5]?\\d):){1}([0-5]?\\d)$" type="text" id="duration" class="form-control" required placeholder="Duration in hh:mm:ss" value="{{$payload->duration}}">
							</div>
						</div>
					</div>
					<div class="form-row">
