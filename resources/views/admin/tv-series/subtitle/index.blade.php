                                    ...
                                    <div class="btn-toolbar" role="toolbar">
                                        <div class="btn-group" role="group">
                                            <a class="btn btn-outline-primary"
                                               href="javascript:____('{{$subtitle->id}}');" @include('admin.extras.tooltip.bottom', ['title' => 'Delete subtitle'])><i
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="custom-file">
                                <input name="file" type="file" class="custom-file-input" id="subtitleFile" accept=".srt"
                                       required>
    ...
    <script type="application/javascript">
        ...
        ____ = key => {
            alertify.confirm("Are you sure? This action is irreversible!",
                yes => {
                    axios.delete(`/admin/tv-series/${video_id}/subtitles/${key}`).then(response => {
                        alertify.alert(response.data.message, () => {
                            location.reload();
                        })
                    }).catch(e => {
