								...
								<td class="text-center">
									<div class="btn-toolbar" role="toolbar">
										<div class="btn-group mx-auto" role="group">
											...
											<a class="btn btn-outline-primary" href="{{route('admin.customers.delete',$user->id)}}" @include('admin.extras.tooltip.bottom', ['title' => 'Delete customer'])><i class="mdi mdi-trash"></i></a>
										</div>
									</div>
								</td>
							</tr>
