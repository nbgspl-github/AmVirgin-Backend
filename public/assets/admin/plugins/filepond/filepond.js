	...
	var createView =
		...
		function createView() {
			var _ref =
				...
				_ref$read = _ref.read,
				read = _ref$read === void 0 ? function () {
				} : _ref$read,
				_ref$write = _ref.write,
				write = _ref$write === void 0 ? function () {
				} : _ref$write,
				_ref$create = _ref.create,
				create = _ref$create === void 0 ? function () {
				} : _ref$create,
				_ref$destroy = _ref.destroy,
				destroy = _ref$destroy === void 0 ? function () {
				} : _ref$destroy,
				...
				didCreateView =
					_ref$didCreateView === void 0 ? function () {
					} : _ref$didCreateView,
				_ref$didWriteView = _ref.didWriteView,
				didWriteView =
					_ref$didWriteView === void 0 ? function () {
					} : _ref$didWriteView,
	...
	var getItemByQueryFromState = function getItemByQueryFromState(
		...
		return function () {
			...
			var query = _ref.query,
				...
				failure = _ref$failure === void 0 ? function () {
				} : _ref$failure,
		...
		return {
			...
			ADD_ITEMS: function ADD_ITEMS(_ref6) {
				var items = _ref6.items,
					...
					failure = _ref6$failure === void 0 ? function () {
					} : _ref6$failure;
			...
			ADD_ITEM: function ADD_ITEM(_ref7) {
				var source = _ref7.source,
					...
					failure = _ref7$failure === void 0 ? function () {
					} : _ref7$failure,
			...
			REQUEST_PREPARE_OUTPUT: function REQUEST_PREPARE_OUTPUT(_ref9) {
				var item = _ref9.item,
					...
					failure = _ref9$failure === void 0 ? function () {
					} : _ref9$failure;
				...
				if (!itemCanBeQueuedForProcessing) {
					...
					if (
						...
						item
							...
							.then(process)
							.catch(function () {
							}); // don't continue with processing if something went wrong
